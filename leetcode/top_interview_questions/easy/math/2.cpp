...
/*
  ...
  Note: I had to follow the hints for the algorithm
*/

class Solution 
{
private:
//   //Logic works till 2 * 10^6. not beyond that
...
public:
  ...
  {
//     //Logic works till 2 * 10^6. not beyond that. So, my approach did not work, then I had to look at the hint. the last one was enough
//     vector<int> primes;
//     for(int i = 2; i < n; ++i)
//     {
//       if(isPrime(i, primes))
...
/* Hints:
  ...
  Hide Hint #1  
    ...
    we need to check if it is not divisible by any number less than n. The runtime complexity of isPrime function would be O(n) 
  ...
  Hide Hint #4  
    ...
    so we mark them off as well. Now we look at the next number, 4, which was already marked off. What does this tell you? 

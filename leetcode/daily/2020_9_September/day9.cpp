...
{
private:
    void getVersionInVector(string &v, vector<int> &result)
    {
        int l = v.size();
...
public:
    ...
    {
        vector<int> ver1;
        getVersionInVector(version1, ver1);

        vector<int> ver2;
        getVersionInVector(version2, ver2);

        int l = ver1.size() > ver2.size() ? ver1.size() : ver2.size();

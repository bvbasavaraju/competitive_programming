/*
  ...
  sorted array which is greater than a given integer”.
  ...
  Output format
  For each query print the smallest integer which is greater than the given one. If there is no such 
